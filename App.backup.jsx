...
export default function App() {
    ...
    return (
        <div
            className={`min-h-screen font-sans antialiased selection:bg-blue-500 selection:text-white transition-colors duration-200 ${isDark ? 'bg-slate-950 text-slate-100' : 'bg-slate-50 text-slate-800'
                }`}
        >
            {/* HEADER PANELS */}
            <nav
                className={`sticky top-0 z-40 border-b px-6 py-4 backdrop-blur-md transition-colors duration-200 ${isDark
                ...
                <div className="mx-auto flex max-w-7xl items-center justify-between">
                    <div className="flex items-center space-x-3.5">
                        ...
                        <div>
                            <div className="flex items-center space-x-2">
                                ...
                                <span
                                    className={`rounded-full px-2.5 py-0.5 text-[11px] font-semibold border ${isDark
                            ...
                            <p
                                className={`text-xs font-medium tracking-wide ${isDark ? 'text-slate-500' : 'text-slate-400'
                                    }`}
                            >
                    ...
                    <div className="flex items-center space-x-3">
                        ...
                        <button
                            ...
                            className={`flex h-9 w-9 items-center justify-center rounded-xl border transition duration-150 active:scale-95 ${isDark
                        ...
                        <button
                            ...
                            className={`flex items-center space-x-2 rounded-xl border px-4 py-2 text-sm font-medium transition duration-150 active:scale-95 ${isDark
            ...
            <main className="mx-auto max-w-7xl p-4 sm:p-6 lg:p-8">
                ...
                {stats.lowStockCount > 0 && (
                    <div
                        className={`mb-8 flex items-center justify-between rounded-xl border bg-gradient-to-r from-amber-500/10 to-transparent p-4 text-sm text-amber-600 dark:text-amber-400 shadow-sm ring-1 ring-amber-500/10 ${isDark ? 'border-amber-500/20' : 'border-amber-500/30'
                            }`}
                    >
                        <div className="flex items-center space-x-3">
                ...
                <div className="mb-8 grid grid-cols-1 gap-5 sm:grid-cols-3">
                    <div
                        className={`group rounded-2xl border p-6 shadow-sm transition-all duration-200 ${isDark
                    ...
                    >
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <h3
                                    className={`mt-2 text-3xl font-extrabold tracking-tight ${isDark ? 'text-white' : 'text-slate-900'
                                        }`}
                                >
                                    {stats.totalItems}
                                </h3>
                            ...
                            <div
                                className={`rounded-xl border p-3 transition-colors ${isDark
                    ...
                    <div
                        className={`group rounded-2xl border p-6 shadow-sm transition-all duration-200 ${stats.lowStockCount > 0
                    ...
                    >
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <h3
                                    className={`mt-2 text-3xl font-extrabold tracking-tight ${stats.lowStockCount > 0
                                            ? 'text-amber-500'
                                            : isDark
                                                ? 'text-white'
                                                : 'text-slate-900'
                            ...
                            <div
                                className={`rounded-xl border p-3 ${stats.lowStockCount > 0
                ...
                <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div className="relative flex-1 max-w-md">
                        ...
                        <input
                            ...
                            className={`w-full rounded-xl border py-2.5 pl-10 pr-4 text-sm outline-none transition duration-150 ${isDark
                    ...
                    <div className="flex items-center space-x-3">
                        <div
                            className={`inline-flex rounded-xl p-1 border ${isDark
                        ...
                        >
                            <button
                                ...
                                className={`rounded-lg px-4 py-1.5 text-xs font-semibold transition-all duration-150 ${filterMode === 'all'
                                        ? isDark
                            ...
                            <button
                                onClick={() => setFilterMode('alerts')}
                                className={`rounded-lg px-4 py-1.5 text-xs font-semibold transition-all duration-150 flex items-center space-x-1 ${filterMode === 'alerts'
                ...
                >
                    {loading && filteredInventory.length === 0 ? (
                        ...
                        <div className="flex flex-col items-center justify-center py-24 text-center px-4 max-w-sm mx-auto">
                            <div
                                className={`flex h-14 w-14 items-center justify-center rounded-2xl mb-5 border shadow-inner ${isDark
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full text-left text-sm border-collapse">
                                <thead
                                    className={`text-xs uppercase tracking-wider border-b ${isDark
                                ...
                                <tbody className="divide-y divide-slate-100 dark:divide-slate-900 bg-transparent">
                                    {filteredInventory.map((item) => {
                                        ...
                                        return (
                                            <tr
                                                key={item.id}
                                                className={`transition-colors duration-150 ${isDark
                                            ...
                                            >
                                                <td className="px-6 py-4">
                                                    ...
                                                    <div className="mt-1 flex items-center space-x-2 text-xs text-slate-400 dark:text-slate-500">
                                                        <span
                                                            className={`font-mono px-2 py-0.5 rounded border ${isDark
                                                                    ? 'bg-slate-900 border-slate-800'
                                                ...
                                                <td className="px-6 py-4">
                                                    <div className="flex items-center justify-center space-x-2.5">
                                                        <button
                                                            ...
                                                            className={`flex h-7 w-7 items-center justify-center rounded-lg border transition active:scale-90 disabled:opacity-30 ${isDark
                                                        ...
                                                        <span
                                                            className={`w-10 text-center text-base font-bold font-mono ${isDark ? 'text-white' : 'text-slate-900'
                                                                }`}
                                                        >
                                                            {item.quantity}
                                                        </span>
                                                        <button
                                                            onClick={() => handleAdjustStock(item, 1)}
                                                            className={`flex h-7 w-7 items-center justify-center rounded-lg border transition active:scale-90 ${isDark
                                                ...
                                                <td
                                                    className={`px-6 py-4 text-right font-mono font-semibold text-base ${isDark ? 'text-slate-200' : 'text-slate-800'
                                                        }`}
                                                >
                                                    ₦
            ...
            {/* HISTORICAL DRAWER */}
            <div
                className={`fixed inset-y-0 right-0 z-50 w-full max-w-md border-l p-6 shadow-2xl transition-transform duration-300 ease-out backdrop-blur-xl ${showLogsDrawer ? 'translate-x-0' : 'translate-x-full'
                    } ${isDark
            ...
            >
                <div
                    className={`flex items-center justify-between border-b pb-4 mb-6 ${isDark ? 'border-slate-900' : 'border-slate-200'
                        }`}
                >
                    ...
                    <button
                        ...
                        className={`rounded-xl border p-2 transition ${isDark
                    ...
                    {logsLoading ? (
                        ...
                        logs.map((log) => {
                            ...
                            return (
                                <div
                                    key={log.id}
                                    className={`rounded-xl border p-4 shadow-sm ${isDark
                                ...
                                >
                                    <div className="flex items-start justify-between">
                                        ...
                                        <span
                                            className={`inline-flex items-center font-mono text-xs font-bold rounded px-2 py-0.5 border ${isAddition
            ...
            {showAddModal && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center bg-slate-950/40 p-4 backdrop-blur-md">
                    <div
                        className={`w-full max-w-md overflow-hidden rounded-2xl border shadow-2xl ${isDark
                                ? 'border-slate-900 bg-slate-900'
                                : 'border-slate-200 bg-white'
                            }`}
                    >
                        <div
                            className={`border-b px-6 py-4.5 ${isDark
                        ...
                        <form onSubmit={handleCreateProduct} className="p-6 space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full rounded-xl border px-3 py-2 text-sm outline-none transition ${isDark
                            ...
                            <div
                                className={`mt-8 flex items-center justify-end space-x-3 pt-4 border-t ${isDark ? 'border-slate-800' : 'border-slate-100'
                                    }`}
                            >
                                <button
                                    type="button"
